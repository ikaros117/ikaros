...
public class CategoryFragment extends Fragment {
    ...
    void init() {
        String[] names = {"background", "fashion", "nature", "science", "education", "feelings", "health", "people", "religion", "places", "animals",
                "industry", "computer", "food", "sports", "transportation", "travel", "buildings", "business", "music"};
        int[] covers = {R.drawable.animals};

        for (int i = 0; i < 20; i++) {
            Category category = new Category(names[i], covers[0]);
